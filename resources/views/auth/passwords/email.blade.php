                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{ asset('images/authentication/login.jpg') }}" alt="branding logo">
                                </div>
                                        ...
                                        <div class="card-content mb-2">
                                            <div class="card-body pt-1">
                                                <form action="{{ route('password.email') }}" method="post">@csrf
                                                    ...
                                                    <button type="submit" class="btn btn-primary float-left btn-inline">{{ __('Send Password Reset Link') }}</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
