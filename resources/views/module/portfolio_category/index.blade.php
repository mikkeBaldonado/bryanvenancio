            		...
            		<div class="card card-dark">
              			...
              			<div class="card-body">
		                	@if(Auth::user()->role != 'Viewer')
              				...
              				@include('module.portfolio_category.create')
              				@endif
                			<div class="col-xl-12">
            					<table id="example1" class="table table-bordered table-striped">
					                ...
					                <tbody>
					                	@foreach($data as $value)
								                ...
								                <td>
									                ...
									                <div class="row pl-1">
									                	...
									                	{{-- <a class="btn btn-info btn-sm text-white mr-1" href="{{ url('Admin/blog_tags/'.$value->id.'/edit') }}" >
								                  		...
								                  		{{-- <a class="delte btn btn-danger btn-sm text-white" data-href="{{ url('Admin/Portfolio_category/'.$value->id) }}" id="deletecart">
									                	  	Delete
									                	</a> --}}
									                </div>
									                @endif
							                ...
							                @include('module.portfolio_category.update')
							            @endforeach
					                </tbody>
					            </table>
                			</div>
