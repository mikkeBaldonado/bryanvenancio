					                ...
					                <tbody>
					                	@foreach($data as $value)
							                <tr>
							                  	...
							                  	<td>{{ $value->title }}</td>
							                  	<td>
							                  		<img src="{{ asset('uploads/logo/'.$value->image) }}" width="100px" class="p-2">
							                  	</td>
								                ...
								                <td>
									                ...
									                <div class="row pl-1">
									                	...
									                	{{-- <a class="btn btn-info btn-sm text-white mr-1" href="{{ url('Admin/Blog/'.$value->id.'/edit') }}" >
								                  		...
								                  		{{-- <a class="delte btn btn-danger btn-sm text-white" data-href="{{ url('Admin/Logo/'.$value->id) }}" id="deletecart">
									                	  	Delete
									                	</a> --}}
									                </div>
									                @endif
